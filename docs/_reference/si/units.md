...
**Note:** The symbols for quantities are normally single letters of the Latin or Greek alphabets, printed in an italic font, and are _recommendations_. The symbols are _mandatory_, printed in an upright font (see [_How to Use Units and Quantities in Equations and Calculations_]({{ site.baseurl }}/howto/write/units.html)).
...
_SI Brochure: The International System of Units (SI) (2019). Bureau International des Poids et Mesures. Ninth Edition. Table 4 (The 22 SI Units with Special Names and Symbols). (SI base units). pg. 138._{: .grey}
...
_SI Brochure: The International System of Units (SI) (2019). Bureau International des Poids et Mesures. Ninth Edition. Table 8 (Non-SI Units Accepted for use With The SI Units). pg. 138._{: .grey}
